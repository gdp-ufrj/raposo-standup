...
func load_data():
	...
	if file:
		...
		TranslationServer.set_locale(get_current_language())
...
func on_language_changed(language : String):
	settings_data_dict["language"] = language
...
func get_current_language():
	return settings_data_dict["language"]
